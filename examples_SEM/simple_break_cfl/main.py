...
if __name__ == "__main__":
    ...
    Np  = 4
    Nt  = 10000
    eps = 1         # paramètre de courant trop grand, CFL non respecté : divergence
    rho0 = 3000
    G0  = 40e9
    ...
    simu = SEM1D(mesh, rho, G, eps, Nt, Np, "break_cfl", path, f0=f0, src="ricker", recep_list=recep_list)
    print(simu)
    simu.run()
